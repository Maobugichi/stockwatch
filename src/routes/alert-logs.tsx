    ...
    <div className="space-y-6  font-inter">
      ...
      <Dialog open={!!editingAlert} onOpenChange={() => setEditingAlert(null)}>
        <DialogContent>
          ...
          <Form submitForm={(e:React.FormEvent<HTMLFormElement>) => submitChanges(e, editingAlert,setSaving,formData,setEditingAlert)} className="space-y-4">
            <Input
             placeholder="condition"
             value={formData.condition}
             type="text"
             name="condition"
             checkInput={handleChangeInput}
            />
